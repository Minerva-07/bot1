...
cl.login(token="EnvnGAyQqb3iB20BRDQ4.KvcFxL5jtlFfl+xvndjK1a.PyOAP/3jxq6F9BxCu13vd+pqqnvmAnrb4BVyWgceFE0=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="EnzcR73mrbMB38Uo22e9.Pnohd24aKtgRF2KJUJr/Yq.NT3AQDofMT8Abx+TEEL+3kXvKMhZY0G+6qY/xDy5zr4=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="En83I7pIApaRgR7UqXv5.JNzsQtUw/05abc3THwb19q.fuItIuVX7bBX5bG0viniAEMsrnWS5W8+KcyW3H08r/U=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="En05a5PdNENQBQ1UPza1.We+lAbBrSTHiMDnltvroiq.6TUbOmyaxr37qMnQriZ0eAbiWTm02XF11pVrWzfb2Sg=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EnVxM3v3b0b5s9Cgua22.LkV/U93QW7XxD7UP5N1rmG.EdH0dRAgZ1ORpAt02hFovevdurdcKtpo3B2sM/ym95I=")
ks.loginResult()
...
helpMessage ="""-= New World Order Bot =-
Owner : Dikaios D
-==================-
◄]·♦·Menu For Public·♦·[►
[•]Adminlist
...
admin=["u3f639d51485dfda947823c2ed86e3a3e"] 
owner=["u3f639d51485dfda947823c2ed86e3a3e"]
whitelist=[""]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    ...
    #--------------- SC Add Admin ---------
              ...
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Dika Yang bisa Gunain Perintah ini.")
    ...
    #-----------------=Selesai=------------------
            ...
            elif msg.text in ["TAKA buka qr","Luffy open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done Sir.")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Vodka buka qr","Zorro open qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Sanji open qr","Tetra buka qr"]:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Already Close Sir")
                else:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Can not be used outside the group")
                    else:
            ...
            elif msg.text in ["Tetra tutup qr","Sanji close qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ξ Pelaku CCTV Ξ\n%s\n Tercyduck \n\n•••••••••••••••\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","One piece","#Bot Join"]: #Panggil Semua Bot
              if msg.from_ in owner:
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    random.choice(KAC).sendText(msg.to,"Room Ga Berguna")                   
                    msg.contentType = 13
                    random.choice(KAC).sendMessage(msg)
                    targets = []
                    for g in gs.members:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"TAKA On")
                ki.sendText(msg.to,"Vodka On")
                kk.sendText(msg.to,"Tetra On")
                kc.sendText(msg.to,"Nanika On")
                ks.sendText(msg.to,"Omega On")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'u3f639d51485dfda947823c2ed86e3a3e'}
              cl.sendMessage(msg)
              cl.sendText(msg.to,"Itu Creator Kami Yang ... Ah gitu lah 😜")
                
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Anjing","Tai","Bangsat","Kampang","Wadidaw","Goblok","Buset","Kontol"]:
                 quote = ['Paansi Jing','Tolong Bahasanya di jaga ','Lo kali ..','Gua Kick lu','Ga seneng?','Bocah ngapa ya?','Lu Ngapa?']
                 psn = random.choice(quote)
                 cl.sendText(msg.to,psn)
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Dosen","Ada dosen","Serius","Seriusan","Beneran","Dosennn","Ada dosen?","Serius?","Seriusan?","Thx","Thank's","Thanks"]:
                 quote = ['Iya Bawel','Jangan Percaya, boong dia','Ah Kupret Lu','Masa sih?','Tai kali?','Iya Jing','Bodo Amat']
                 psn = random.choice(quote)
                 ki.sendText(msg.to,psn)     
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐== NWO ==⭐⭐👈\n\n™SMULE VOICE FAMILY™")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^NWO Bot^\nStatus Boss udah Kami Like\nOwner Kami :\nDikaios D")
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"=====Ready=====\n[★]Bot Protect For Group\n[★]\n[★]Selfbot in Your Account[★]\n- 1 Selfbot 1 Bot Assist\n- 1 Selfbot 2 Bot Assist\n- 1 Selfbot 3 Bot Assist\n- 1 Selfbot 4 Bot Assist\n- 1 Selfbot 5 Bot Assist\n\nMau Coba Atau Test Terlebih Dahulu Bisa\nMinat??? PM Id Line @c_lucif\nLagu Promo Lho Kak\n===[★]NWO Bot Protect[★]===")
                    print "Like"
                except:
                    pass
